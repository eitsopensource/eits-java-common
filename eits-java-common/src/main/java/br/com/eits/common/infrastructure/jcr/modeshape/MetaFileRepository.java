...
public class MetaFileRepository implements IMetaFileRepository
{
	...
	public MetaFile insert( MetaFile metaFile ) throws RepositoryException, IOException
	{
		...
		final Node fileNode = this.manager.uploadFile( this.session, metaFile.getPath(), metaFile.getInputStream() );
	 ...
	 *
	 * (non-Javadoc)
	 * @see br.mil.fab.sisplaer.core.domain.repository.IMetaFileRepository#removeByFolder(java.lang.String)
	 */
	@Override
