package br.com.eits.common.infrastructure.report.jasper;
...
public class JasperReportManager implements IReportManager
{
    ...
    //------
    // IReportManager implementations
    //------
    
	/* (non-Javadoc)
	 * @see br.com.eits.common.infrastructure.report.IReportManager#exportToPDF(java.util.Map, java.lang.String)
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see br.com.eits.common.infrastructure.report.IReportManager#exportToHTML(java.util.Map, java.lang.String)
	 */
	@Override
